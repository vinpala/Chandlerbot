...
import time
import os
#Emetrics will be responsible for writing the model’s results into the logs and formatting it in the way
#that Watson Studio interface expects.
class EMetrics(object):
    ...
    def close(self):
        ...
        if self.train_history:
            open(os.path.join(folder,"val_dict_list.json"),"w").write(json.dumps(self.train_history))
